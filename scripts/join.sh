...
case "$AGENT_TYPE" in
  claude-code|codex|gemini|antigravity|cursor|copilot) ;;
  *) echo "Unknown agent type: '$AGENT_TYPE' (supported: claude-code, codex, gemini, antigravity, cursor, copilot)" >&2; exit 1 ;;
esac
